...
### Test audio
mpg123 -a hw:00,00 $BASEDIR/Audio/power_on.mp3
check_result "Did you hear a sound"

### Test EEPROM driver
UBUNTU_CODENAME=$(lsb_release -cs)
if [ "$UBUNTU_CODENAME" == "noble" ]; then
    hexdump /sys/bus/nvmem/devices/3-00502/nvmem
...
echo 0 > /sys/class/gpio/gpio${GPIO21}/value
echo 0 > /sys/class/gpio/gpio${GPIO25}/value
sleep 1
echo 1 > /sys/class/pwm/pwmchip0/pwm4/enable
echo 1 > /sys/class/gpio/gpio${GPIO21}/value
echo 1 > /sys/class/gpio/gpio${GPIO25}/value
